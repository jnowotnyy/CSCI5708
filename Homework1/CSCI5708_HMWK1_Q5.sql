...
id CHAR(20),
Name CHAR(50),
Professor_Name CHAR(50),
constraint pk_Project primary key (id, Professor_Name),
constraint fk_Professor foreign key (Professor_Name) references Professor(Name) on delete cascade
);
...
Graduate_Email CHAR(20),
constraint pk_Advises primary key (Graduate_Email,Professor_Email),
